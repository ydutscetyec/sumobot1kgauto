<?php
/**
 * Archive template — used for category pages such as /category/balita/,
 * so the nav and footer "section" links land on a real listing.
 */
get_header();
?>
...
<main class="container section-block">
  ...
  <div class="cards-grid">
    ...
    <?php $i++; endwhile; else : ?>
      <p><?php esc_html_e( 'Wala pang artikulo sa seksyong ito.', 'ang-bantayog' ); ?></p>
    <?php endif; ?>
  </div>
