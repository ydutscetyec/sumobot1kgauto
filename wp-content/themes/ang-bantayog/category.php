...
$bago    = new WP_Query( array( 'posts_per_page' => 4, 'category_name' => $slug, 'orderby' => 'date', 'no_found_rows' => true ) );
$laganap = new WP_Query( array( 'posts_per_page' => 4, 'category_name' => $slug, 'orderby' => 'comment_count', 'no_found_rows' => true ) );
?>
    ...
    <div class="balita-layout">
      ...
      <div class="balita-main">
        <div class="balita-card-row">
          <?php if ( $cat_posts->have_posts() ) : $i = 0; while ( $cat_posts->have_posts() ) : $cat_posts->the_post(); ?>
